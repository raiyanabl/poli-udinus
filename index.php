...
<body>
    ...
    if (isset($_GET['page'])) {
        ...
        echo "<br><h2>&nbsp;Selamat Datang di Sistem Sistem Temu Janji Pasien - Dokter"; 

        if (isset($_SESSION['username' . 'nama'])) {
            // jika sudah login tampilkan username
            echo ", " . $_SESSION['username' . 'nama'] . "</h2><hr>";
        } else {
            echo "</h2><hr>&nbsp;&nbsp;&nbsp;Silakan login untuk mengakses akun Anda. Jika Anda belum memiliki akun, silakan melakukan registrasi untuk mendapatkan akses penuh ke Poliklinik UDINUS.<hr>"; 
        }
    }
    ?>
